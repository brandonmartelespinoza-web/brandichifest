// verify19.mjs — verificación funcional de GUIA-SEM19.html en Chromium real (clicks, no llamadas directas)
import { createRequire } from 'module';
const require = createRequire('/opt/node22/lib/node_modules/');
const { chromium } = require('playwright');
import fs from 'fs';

const URL = 'http://127.0.0.1:8719/GUIA-SEM19.html';
const TABS = ['par', 'pul', 'med', 'mec', 'esp', 'gas', 'vqr', 'tim', 'org', 'test'];
const out = [];
...
const raw = fs.readFileSync('/home/user/brandichifest/SEM 19/GUIA-SEM19.html', 'utf8');
